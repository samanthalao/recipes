...
2. Pour the hot water into the bowl with matcha powder.

3. Using a matcha whisk (chasen), whisk in an M shape motion until the matcha is fully dissolved.

4. Heat your milk in the microwave (do not exceed 150 F if using dairy milk). Add sweeter to the milk (optional). Froth your milk using an electric hand frother. 

5. Pour the whisked matcha into your cup, then pour the milk.
